...
class DiskCache:
    ...
    Initialization components:
        ...
        encoding (str): character encoding for compression (defaut: utf-8)
        expires (datetime.timedelta): timedelta when content will expire
            (default: 30 days ago)
    """

    def __init__(self, cache_dir='../data/cache', max_len=255, compress=True, encoding='utf-8', expires=timedelta(days=30)):
