...
def get_links(html):
    " Return a list of links (using simple regex mathcing) from the html content"
...
def link_crawler(start_url, link_regex, robots_url=None, user_agent='wswp',
    ...
    :param robots_url: (str) url of the site's robots.txt (default: start_url + /robots.txt)
