...
def threaded_crawler(start_url, link_regex, user_agent='wswp', proxies=None,
    ...
    :param start_url: (str or list of strs) website(s) to start crawl
    ...
    :param cache: (dict) cache dict with urls as keys and dicts as responses (default: {})
    :param max_threads:
    ...
    def process_queue():
        ...
        while threads or crawl_queue:
            ...
            while len(threads) < max_threads and crawl_queue:
                ...
                thread.setDaemon(True) # set deamon so main thread can exit with ctrl-c
                thread.start()
